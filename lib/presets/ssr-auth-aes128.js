...
const MAX_TIME_DIFF = 30;class SsrAuthAes128Preset extends _defs.IPreset {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this._clientId = null, this._connectionId = null, this._userKey = null, this._hashFunc = DEFAULT_HMAC_HASH_FUNC, this._salt = DEFAULT_SALT, this._isHeaderSent = false, this._isHeaderRecv = false, this._encodeChunkId = 1, this._decodeChunkId = 1, this._adBuf = null, _temp;
  }
  ...
  createChunks(buffer) {
    ...
    return (0, _utils.getRandomChunks)(buffer, 0x1fff - 0xff - 8 - 3, 0x2000 - 0xff - 8 - 3).map(payload => {
      ...
      if (first < 128) {
        ...
        random_bytes = Buffer.concat([Buffer.from([0xff]), (0, _utils.numberToBuffer)(_len + 1, 2, _utils.BYTE_ORDER_LE), _crypto2.default.randomBytes(_len - 2)]);
      }
