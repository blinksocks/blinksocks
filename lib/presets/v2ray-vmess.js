...
class V2rayVmessPreset extends _defs.IPresetAddressing {
  constructor(...args) {
    ...
    return _temp = super(...args), this._uuid = null, this._security = null, this._atyp = null, this._host = null, this._port = null, this._isBroadCasting = false, this._staging = Buffer.alloc(0), this._isHeaderSent = false, this._isHeaderRecv = false, this._v = null, this._opt = 0x05, this._dataEncKey = null, this._dataEncKeyForChaCha20 = null, this._dataEncIV = null, this._dataDecKey = null, this._dataDecKeyForChaCha20 = null, this._dataDecIV = null, this._chunkLenEncMaskGenerator = null, this._chunkLenDecMaskGenerator = null, this._cipherNonce = 0, this._decipherNonce = 0, _temp;
  }
  ...
  static updateAuthCache(uuid, store) {
    ...
    for (let ts = from; ts <= to; ++ts) {
      const authInfo = (0, _utils.hmac)('md5', uuid, (0, _utils.numberToBuffer)(ts, 8));
  ...
  serverIn({ buffer, next, fail }) {
    if (!this._isHeaderRecv) {
      ...
      const ts = (0, _utils.numberToBuffer)(cacheItem.timestamp, 8);
